...
> **Note**: The `@eventHandler` tag introduced in ShockScript is used for documenting events better in reactive systems that use record types rather than classes for component parameters.
